...
import {MessageSquare, ThumbsUp, UserPlus, Eye,ExternalLink,Trash2 } from 'lucide-react';
...
const NotificationPage = () => {
    ...
    //1. icon-renderering -Comment -ConnectionReq -Like
    const renderNotificationIcon = (type)=> {
        switch(type) {
            case "like" :
                return <ThumbsUp size = {17} className='text-blue-500'/>
            case "comment" :
                return <MessageSquare size = {17} className='text-green-500'/>
            case "connectionAccepted" :
                return <UserPlus size = {17} className='text-purple-500'/>
            default :
                return null;
        }
    }
								...
								>
									<div className='flex items-start justify-between'>
										...
										<div className='flex gap-2'>
											{!notification.read && (
												<button
													onClick={() => markReadMutation(notification._id)}
