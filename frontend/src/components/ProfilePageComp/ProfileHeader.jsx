...
import {UserCheck, X, Clock, UserPlus, Camera, MapPin} from 'lucide-react';
  ...
  return (
    <div className='bg-white shadow rounded-lg mb-6'>
      <div
        ...
        style={{
          backgroundImage:`url('${editedData.bannerImg || userData.bannerImg || "/bg1.jpeg"}')`
        }}
      >
        {isEditing && (
        ...
        <div className='text-center mb-4 '>
          {isEditing ? (
            <input
              ...
              className='text-2xl font-bold mb-2 text-center w-full border border-gray-300 rounded-md px-3 py-2'  
            />
          ...
          {isEditing ? (
            <input
              ...
              className='text-gray-600 text-center w-full border border-gray-300 rounded-md px-3 py-2'
              />
          ):(
          ...
          <div className='flex justify-center items-center mt-2 '>
            ...
            {isEditing ? (
              <input
                ...
                className='text-gray-600 text-center border border-gray-300 rounded-md px-3 py-2'
                />
            ) : (
